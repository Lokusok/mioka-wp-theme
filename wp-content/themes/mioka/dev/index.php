...
<main id="main" class="main">
        ...
        <div class="container">
          ...
          <div class="reviews__line">
            <div class="reviews-block reviews-photos">
              <div class="reviews-block__header">
                <span class="reviews-block__title">
                  <b class="marker"><?php the_field('photoreviews_title_bold') ?></b><?php the_field('photoreviews_title_default') ?>
                </span>
                <a class="reviews-block__link" href="<?php the_field('photoreviews_link_href') ?>" target="_blank"><?php the_field('photoreviews_link_text') ?></a>
              </div>
            ...
            <div class="reviews-block reviews-text">
              <div class="reviews-block__header">
                <span class="reviews-block__title">
                  <b class="marker"><?php the_field('textreviews_title_bold') ?></b><?php the_field('textreviews_title_default') ?>
                </span>
                <a class="reviews-block__link" href="<?php the_field('textreviews_link_href') ?>" target="_blank"><?php the_field('textreviews_link_text') ?></a>
              </div>
                    ...
                    foreach( $myposts as $post ):
                      ...
                      <li class="review">
                        <article class="review__inner">
                          <h3 class="visually-hidden">Отзыв от <?php the_title() ?></h3>
    ...
    <section id="questions" class="questions">
      <div class="questions__row">
        <div class="container">
          <h2 class="section-title questions__title"><?php the_field('questions_default_title') ?> <b class="marker"><?php the_field('questions_bold_title') ?></b></h2>
                    ...
                    ?>
                      <li class="question">
                        <button class="question__inner" type="button" aria-expanded="false" aria-controls="question__answer">
                          <span class="question__title"><?php the_title() ?></span>
      ...
      <div class="documents__row">
        <div class="container">
          <h2 class="section-title documents__title">
            <?php the_field('documents_default_title') ?> <b class="marker"><?php the_field('documents_bold_title') ?></b>
          </h2>
    ...
    <section id="contacts" class="contacts">
      <div class="contacts__row">
        <div class="container">
          <h2 class="section-title contacts__title"><?php the_field('contacts_default_title') ?> <b class="marker"><?php the_field('contacts_bold_title') ?></b></h2>
          <p class="section-subtitle contacts__subtitle"><?php the_field('contacts_subtitle') ?></p>
            ...
            <div class="contacts__info">
              <article class="tilt-card  info-block">
                ...
                <address class="info-block__info">
                  <span class="info-block__item">
                    <!-- <?php the_field('contacts_card_address') ?> -->
                    <?php the_field('studio_address') ?>
                  </span>
                  <span class="info-block__item">
                    <?php the_field('contacts_schedule') ?>
                  </span>
                  <span class="info-block__item">
                    <?php the_field('contacts_tel_nums') ?>
                  </span>
                  <a class="info-block__item blue" href="mailto:<?php the_field('contacts_email') ?>">
              ...
              <article class="tilt-card  info-block">
                ...
                <p class="info-block__text">
                  <?php the_field('contacts_info_text') ?>
                </p>
              </article>
            </div>
            ...
            <ul class="contacts__social social-list">
              ...
              ?>
                <li class="social-list__item">
                  <a class="social-list__item" href="<?= $vk_href ?>" target="_blank" title="<?php bloginfo('title') ?> в ВКонтакте">
              ...
              ?>
                <li class="social-list__item">
                  <a class="social-list__item" href="<?= $tg_href ?>" target="_blank" title="<?php bloginfo('title') ?> в Telegram">
              ...
              ?>
                <li class="social-list__item">
                  <a class="social-list__item" href="<?= $ok_href ?>" target="_blank" title="<?php bloginfo('title') ?> в Одноклассниках">
              ...
              ?>
              <li class="social-list__item">
                <a class="social-list__item" href="<?= $whatsapp_href ?>" target="_blank" title="<?php bloginfo('title') ?> в WhatsApp">
              ...
              ?>
                <li class="social-list__item">
                  <a class="social-list__item" href="<?= $youtube_href ?>" target="_blank" title="<?php bloginfo('title') ?> в YouTube">
              ...
              ?>
              <li class="social-list__item">
                <a class="social-list__item" href="<?= $dzen_href ?>" target="_blank" title="<?php bloginfo('title') ?> в Яндекс Дзен">
  ...
  <div class="popup trigger-result popup-footer-form">
    <div class="trigger-result__content popup__content">
      <button class="close popup-close" type="button" aria-label="закрыть уведомление об отправке формы">
      ...
      <button class="orange-gradient-btn accept popup__accept" type="button">
          ...
          >
            <div class="modal-form__inner">
              ...
              <div class="modal-form-field submit-field">
                <button id="modal-form-submit" class="trigger modal-form__submit orange-gradient-btn" type="submit" data-trigger-result-selector=".access-modal">
  ...
  <div class="modal trigger-result access-modal">
    <div class="trigger-result__row modal__row">
      <div class="trigger-result__container modal__container">
        <div class="trigger-result__content modal__content access-modal__content">
  ...
  <!-- Попап, показывающийся при отправке формы на оформление записи -->
  <div class="popup trigger-result popup-modal-form">
    <div class="trigger-result__content popup__content">
      <button class="close popup-close" type="button" aria-label="закрыть уведомление об отправке формы">
        <span class="popup-close__inner">
          <svg class="popup-close__icon" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <p class="popup__descr">
        Ожидайте звонка. Следующая отправка формы будет доступна через 12 часов.
      </p>
      <button class="orange-gradient-btn accept popup__accept" type="button">
        <span class="orange-gradient-btn__inner popup__accept-inner">
          Понятно
  ...
  <!-- Модалка ошибки отправки форм -->
  <div class="modal trigger-result error-modal access-modal">
    <div class="trigger-result__row modal__row">
      <div class="trigger-result__container modal__container">
        <div class="trigger-result__content modal__content access-modal__content">
          <button class="close modal-close access-modal__close" type="button">
          ...
          <span class="modal__title access-modal__title">Ошибка отправки формы</span>

          <div class="acces-modal__btn-wrapper">
            <button 
              type="button"
              class="trigger error-modal__button access-modal__button access-modal__accept orange-gradient-btn"
              >
              <span class="orange-gradient-btn__inner">
                Повторить позже
              </span>
